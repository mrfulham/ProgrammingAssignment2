## Takes a matrix and inititalizes the functions set, get, setinverse, and getinverse and the names i and x to the makeCacheMatrix() environment. 
## Then uses cacheSolve() function to check if the listed function getinverse is cached for the matrix in question. 
## If not, it passes the inverse of the matrix to the listed function setinverse. 
...
# If it is not cached, it caches the inverse with the setinverse() function stored within makeCacheMatrix.
